...
// Controller for tutor to review the user on behalf of the elderly
export const tutorSubmitReview = async (req, res) => {
  ...
  try {
    ...
    const newReview = await ServiceReview.create({
      service_id: serviceId,
      rating_user,       // Rating given by the tutor for the user
      comment_user,      // Optional comment
